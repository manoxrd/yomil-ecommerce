  ...
  <div class="flex min-h-screen justify-start bg-background">
    <SidebarProvider class="w-fit">
      <FilteringSidebar :categories="categories" :selected-rating="currentRating" :max-price="maxPrice"
        :min-price="minPrice" :currentCategory="currentCategory" @select-category="onCategorySelect"
    ...
    <div class="flex-1 p-6">
      ...
      <div class="flex items-center justify-center py-10 gap-x-4">
        ...
        <Link v-if="products.current_page > 1" :href="products.first_page_url" class="flex items-center justify-center">
          1</Link>
